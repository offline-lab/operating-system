...
@test "string::lower: returns 2 with more than 1 argument" {
...
@test "string::upper: returns 2 with more than 1 argument" {
...
@test "string::length: returns 2 with more than 1 argument" {
...
@test "string::chomp: returns 2 with more than 1 argument" {
...
@test "string::trim: returns 2 with more than 1 argument" {
    run string::trim "a" "b"
    [ "$status" -eq 2 ]
}
...
@test "string::lstrip: returns 2 with more than 1 argument" {
    run string::lstrip "a" "b"
    [ "$status" -eq 2 ]
}
